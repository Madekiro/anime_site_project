...
<body>
    <div class="rightcolumn">
        <p class="bodyp"> История разворачивается вокруг девочки по имени Сэна, одной из детей, владеющей силой «Мечта Алисы», которая позволяет воплощать в жизнь всё, что носитель представит. После побега из лаборатории, где она была подопытной, она оказывается в обычном мире, где встречает старика Зороку. Но сможет ли он ей помочь? </p>
    </div>
    <div class="leftcolumn">
        <p class="bodyp"> Назва </p>
        <p class="bodyp"> Картинка </p>
        <p class="bodyp"> Рік </p>
        <p class="bodyp"> Жанри </p>
        <p class="bodyp"> Тип </p>
